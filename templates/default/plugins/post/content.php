	...
	if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST")
		{
            ...
            //  date_default_timezone_set('Australia/Melbourne');
              ...
              $url_image=$url."templates/default/plugins/post/upload_temp/".$actual_image_name;
                    ...
                    <img style='width:100px; height: 100px;' src='".$url_image."'  class='preview'>";
								  echo'<input type="hidden" value="'.$actual_image_name.'" id="img_content_post" class="img_content_post" name="img_content_post[]">';
